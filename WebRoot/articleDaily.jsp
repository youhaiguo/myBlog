			...
			<div class="about left">
				...
				<ul>
					...
					<p class="newsnav">
						...
						&nbsp;>&nbsp;
						<a href="${pageContext.request.contextPath}/Client?op=articleDaily">扯日常</a>
					</p>
					<p>${article.content }</p>
					<div class="nextinfo">
						<p>
							上一篇：
							<a
								href="${pageContext.request.contextPath}/Client?op=articleDailyById&articleId=${article.nextArticle.articleId}">
								<font color="yellow">${article.nextArticle.title }</font>
							</a>
						</p>
						<p>
							下一篇：
							<a href="${pageContext.request.contextPath}/Client?op=articleDailyById&articleId=${article.preArticle.articleId}">
